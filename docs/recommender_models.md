...
the step-by-step guide for shipping a new model.
...
- **Where**: `_run_expert_action_filter(context)` in the library, invoked
  by `run_analysis_step2_discovery` whenever the chosen model declares
...
- Library-side contract: [`marota/expert_op4grid_recommender` — docs/recommender_models.md](https://github.com/marota/expert_op4grid_recommender/blob/main/docs/recommender_models.md)
